    ...
    for (let i = 0; i < arr.length; i++) {
      if (arr[i].Descrit.length >= 700) {
        code += `<div style='flex-basis: calc(100% - 48px)' class='card'>
                <b>${arr[i].Titulo}</b><br>
                <a href='javascript:bclipper("${arr[i].Descrit} (${arr[i].Autor}, ${arr[i].Ano}, ${arr[i].Ref})");'>"${arr[i].Descrit}" (${arr[i].Autor}, ${arr[i].Ano}, ${arr[i].Ref})</a><br>
                `;
      ...
      if (arr[i].Livro != "" && typeof arr[i].Livro != "undefined") {
        if (typeof arr[i].Link != "undefined" && arr[i].Link != "") {
          code += `<div class='refer'>
                    ...
                    </svg></a> <a href='javascript:bclipper("${arr[i].Autor}. ${arr[i].Livro}, ${arr[i].Ano}")'>${arr[i].Autor}. ${arr[i].Livro}, ${arr[i].Ano}</a></div>
                    </div>`;
        } else {
          code += `<div class='refer'>
                    <div><a href='javascript:bclipper("${arr[i].Autor}. ${arr[i].Livro}, ${arr[i].Ano}")'>${arr[i].Autor}. ${arr[i].Livro}, ${arr[i].Ano}</a></div>
                    </div>`;
        }
      }
