let visse = function (par) {
  let jsonfile = `https://docs.google.com/spreadsheets/d/1d9eKw82lnM5GvVkBUe8wLcHSxpmDm5B6dUqWRbazOik/edit?gid=1891587284#gid=1891587284`; // Change the URL here (imperative)
  ...
  let typekey = `ano`; // Change the Key for the link type of the links, if needed
