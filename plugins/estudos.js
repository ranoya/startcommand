let estudos = function (par) {
  // Change the funcion name here (imperative)

  let jsonfile = `https://docs.google.com/spreadsheets/d/1Gya-umpS7Zh3v8qA8OUCFsb0yXG9DjnnYEmyiwF4a3Y/edit#gid=1756373530`; // Change the URL here (imperative)
  ...
  getcsvdata(GoogleSheetCsvURL(jsonfile), function (jsondata) {
      ...
      let code = `<div class="outputgrid"><span class='categoria noline' style='border: 0;'>Planejamento de estudos</span><span class='categoria'>&nbsp;</span>`;
